package co.youngleader.rhino.adminweb.rest.service;
...
import co.youngleader.rhino.adminweb.rest.dao.PodcastDao;
import co.youngleader.rhino.adminweb.rest.dao.PodcastEntity;
import co.youngleader.rhino.adminweb.rest.errorhandling.AppException;
import co.youngleader.rhino.adminweb.rest.errorhandling.CustomReasonPhraseException;
import co.youngleader.rhino.adminweb.rest.filters.AppConstants;
import co.youngleader.rhino.adminweb.rest.helpers.NullAwareBeanUtilsBean;
import co.youngleader.rhino.adminweb.rest.resource.podcast.Podcast;
...
public class PodcastServiceDbAccessImpl implements PodcastService {
	...
	private boolean isFullUpdate(Podcast podcast) {
		return podcast.getId() == null || podcast.getFeed() == null || podcast.getLinkOnPodcastpedia() == null
				|| podcast.getTitle() == null || podcast.getDescription() == null;
	}
